...
final class DaisyBaseXAConnection implements XAConnection {
    private final DaisyBaseConnection connection;
    private final DaisyBaseXAResource resource;
    ...
    DaisyBaseXAConnection(DaisyBaseConnection connection) {
        this.connection = connection;
        this.resource = new DaisyBaseXAResource(connection);
    }
