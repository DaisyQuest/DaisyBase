...
final class DaisyBaseParameterMetaData {
    private DaisyBaseParameterMetaData() {
    }
    ...
    static ParameterMetaData create(List<ParameterDescriptor> descriptors) {
        ...
        return (ParameterMetaData) Proxy.newProxyInstance(
                DaisyBaseParameterMetaData.class.getClassLoader(),
                ...
                (proxy, method, args) -> switch (method.getName()) {
                    ...
                    case "toString" -> "DaisyBaseParameterMetaData[count=" + normalized.size() + "]";
