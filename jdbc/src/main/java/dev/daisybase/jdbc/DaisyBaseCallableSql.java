...
final class DaisyBaseCallableSql {
    ...
    private DaisyBaseCallableSql(String nativeSql, String schemaName, String routineName,
    ...
    static DaisyBaseCallableSql parse(String sql) throws SQLException {
        ...
        return new DaisyBaseCallableSql(nativeSql, schemaName, routineName, hasReturnValue, argumentCount);
    }
