...
final class DaisyBaseArray implements Array {
    private final String typeName;
    private final int baseType;
    private Object[] elements;

    DaisyBaseArray(String typeName, Object[] elements) {
        this.typeName = typeName;
        this.baseType = DaisyBaseJdbcObjects.jdbcTypeForArrayTypeName(typeName);
