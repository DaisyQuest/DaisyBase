...
final class DaisyBaseDatabaseMetaData {
    private DaisyBaseDatabaseMetaData() {
    }

    static DatabaseMetaData create(DaisyBaseConnection connection) {
        return (DatabaseMetaData) Proxy.newProxyInstance(
                DaisyBaseDatabaseMetaData.class.getClassLoader(),
                new Class[]{DatabaseMetaData.class},
                (proxy, method, args) -> switch (method.getName()) {
                    case "getConnection" -> connection;
                    case "getURL" -> connection.jdbcUrl();
                    case "getUserName" -> connection.jdbcUser();
                    case "getDriverName" -> DaisyBaseDriver.NAME;
                    case "getDriverVersion" -> DaisyBaseDriver.MAJOR_VERSION + "." + DaisyBaseDriver.MINOR_VERSION;
                    case "getDriverMajorVersion" -> DaisyBaseDriver.MAJOR_VERSION;
                    case "getDriverMinorVersion" -> DaisyBaseDriver.MINOR_VERSION;
                    case "getDatabaseProductName" -> "DaisyBase";
                    ...
                    case "usesLocalFiles" -> connection.jdbcUrl().startsWith("jdbc:daisybase:embedded:");
                    ...
                    case "getCatalogs" -> DaisyBaseResultSets.empty("TABLE_CAT");
                    ...
                    case "toString" -> "DaisyBaseDatabaseMetaData[" + connection.jdbcUrl() + "]";
    ...
    private static ResultSet tableTypes() throws SQLException {
        return DaisyBaseResultSets.fromTupleBatch(new Common.TupleBatch(
    ...
    private static ResultSet emptyMetadata(String... columns) throws SQLException {
        return DaisyBaseResultSets.empty(columns);
    }
