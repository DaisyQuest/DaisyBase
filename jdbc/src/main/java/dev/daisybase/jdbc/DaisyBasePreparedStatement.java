...
class DaisyBasePreparedStatement extends DaisyBaseStatement implements PreparedStatement {
    private final String sql;
    private final DaisyBasePreparedSql preparedSql;
    private final DaisyBaseTransport.PreparedHandle preparedHandle;
    private final List<DaisyBasePreparedSql.BoundParameter> parameters;
    private final boolean returnGeneratedKeys;

    DaisyBasePreparedStatement(DaisyBaseConnection connection, int resultSetType, int resultSetConcurrency,
                            String sql, boolean returnGeneratedKeys) throws SQLException {
        super(connection, resultSetType, resultSetConcurrency);
        this.sql = sql;
        this.preparedSql = DaisyBasePreparedSql.parse(sql);
    ...
    public ParameterMetaData getParameterMetaData() {
        return DaisyBaseParameterMetaData.create(preparedHandle.parameterDescriptions(), visibleParameterCount());
    }
    ...
    public java.sql.ResultSetMetaData getMetaData() throws SQLException {
        ...
        return DaisyBaseResultSets.metaData(preparedHandle.resultColumns());
    }
    ...
    public void setBinaryStream(int parameterIndex, InputStream x, int length) throws SQLException {
        bind(parameterIndex, DaisyBaseJdbcObjects.readBinary(x), Types.BLOB);
    }
    ...
    public void setBlob(int parameterIndex, InputStream inputStream, long length) throws SQLException {
        bind(parameterIndex, DaisyBaseJdbcObjects.readBinary(inputStream), Types.BLOB);
    }
    ...
    protected void bind(int parameterIndex, Object value, Integer sqlType) throws SQLException {
        ...
        parameters.set(internalIndex - 1, DaisyBasePreparedSql.BoundParameter.of(
                DaisyBaseJdbcObjects.normalizeParameterValue(value), effectiveSqlType));
    }
    ...
    protected String renderParameters(List<DaisyBasePreparedSql.BoundParameter> boundParameters) throws SQLException {
    ...
    protected List<DaisyBasePreparedSql.BoundParameter> parameterValues() {
        return parameters;
    }
