...
final class DaisyBaseUpdatableQueries {
    private DaisyBaseUpdatableQueries() {
    }

    static Descriptor describe(String sql, Common.TupleBatch batch, DaisyBaseConnection connection) throws SQLException {
    ...
    private static List<String> primaryKeyColumns(DaisyBaseConnection connection, String schemaName, String tableName) throws SQLException {
