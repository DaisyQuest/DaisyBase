...
final class DaisyBaseUpdatableResultSet {
    private DaisyBaseUpdatableResultSet() {
    }

    static ResultSet create(DaisyBaseStatement statement, CachedRowSet rowSet,
                            DaisyBaseUpdatableQueries.Descriptor descriptor) throws SQLException {
        ...
        return (ResultSet) Proxy.newProxyInstance(
                DaisyBaseUpdatableResultSet.class.getClassLoader(),
    ...
    private static final class State {
        private final DaisyBaseStatement statement;
        private final CachedRowSet rowSet;
        private final DaisyBaseUpdatableQueries.Descriptor descriptor;
        private List<Object[]> keySnapshots = List.of();
        private boolean insertMode;

        private State(DaisyBaseStatement statement, CachedRowSet rowSet, DaisyBaseUpdatableQueries.Descriptor descriptor) {
        ...
        private String sqlLiteral(Object value, Common.ResultColumn column) throws SQLException {
            ...
            return DaisyBasePreparedSql.BoundParameter.of(DaisyBaseJdbcObjects.normalizeParameterValue(value), jdbcType).sqlLiteral();
        }
