...
final class EmbeddedDaisyBaseTransport implements DaisyBaseTransport {
    ...
    EmbeddedDaisyBaseTransport(DaisyBaseUrl url) throws SQLException {
    ...
    public EngineApi.BatchResult execute(String sql, long executionId, long timeoutMillis) throws SQLException {
        ...
        try {
            ...
            throw DaisyBaseExceptionFactory.fromException(runtimeException);
        } finally {
