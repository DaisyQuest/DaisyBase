...
final class JavaDbPreparedSql {
    private final List<String> segments;
    private final int parameterCount;

    private JavaDbPreparedSql(List<String> segments, int parameterCount) {
        this.segments = segments;
        this.parameterCount = parameterCount;
    }

    static JavaDbPreparedSql parse(String sql) throws SQLException {
        ...
        segments.add(current.toString());
        return new JavaDbPreparedSql(List.copyOf(segments), parameters);
    }
