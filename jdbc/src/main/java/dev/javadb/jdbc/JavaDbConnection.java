...
final class JavaDbConnection implements Connection {
    private final JavaDbUrl url;
    private final JavaDbTransport transport;
    private final Set<JavaDbStatement> openStatements = Collections.newSetFromMap(new IdentityHashMap<>());
    ...
    JavaDbConnection(JavaDbUrl url) throws SQLException {
        this.url = Objects.requireNonNull(url, "url");
        this.transport = switch (url.mode()) {
            case EMBEDDED -> new EmbeddedJavaDbTransport(url);
            case REMOTE -> new RemoteJavaDbTransport(url);
        };
    }
    ...
    JavaDbTransport.PreparedHandle prepareSql(String sql) throws SQLException {
        ensureOpen();
    ...
    DatabaseMetaData databaseMetaData() {
        return JavaDbDatabaseMetaData.create(this);
    }
    ...
    void register(JavaDbStatement statement) {
        openStatements.add(statement);
    }

    void unregister(JavaDbStatement statement) {
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        JavaDbStatement statement = new JavaDbStatement(this, resultSetType, resultSetConcurrency);
        register(statement);
        return statement;
    }
    ...
    @Override
    public JavaDbPreparedStatement prepareStatement(String sql) throws SQLException {
        return prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY, false);
    }

    @Override
    public JavaDbPreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return prepareStatement(sql, resultSetType, resultSetConcurrency, false);
    }

    private JavaDbPreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
                                                     boolean returnGeneratedKeys) throws SQLException {
        ensureResultSetSupport(resultSetType, resultSetConcurrency);
        JavaDbPreparedStatement statement = new JavaDbPreparedStatement(this, resultSetType, resultSetConcurrency, sql, returnGeneratedKeys);
        register(statement);
        return statement;
    }

    @Override
    public JavaDbPreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ensureHoldability(resultSetHoldability);
        return prepareStatement(sql, resultSetType, resultSetConcurrency, false);
    }

    @Override
    public JavaDbPreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    ...
    @Override
    public JavaDbPreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY,
                columnIndexes != null && columnIndexes.length > 0);
    }

    @Override
    public JavaDbPreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY,
    ...
    public java.sql.CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        ensureResultSetSupport(resultSetType, resultSetConcurrency);
        JavaDbCallableStatement statement = new JavaDbCallableStatement(this, resultSetType, resultSetConcurrency, sql);
        register(statement);
        return statement;
    }
    ...
    public void rollback(Savepoint savepoint) throws SQLException {
        ...
        JavaDbSavepoint javaDbSavepoint = requireSavepoint(savepoint);
    ...
    public Savepoint setSavepoint(String name) throws SQLException {
        ...
        beginIfNeeded();
        JavaDbSavepoint savepoint = new JavaDbSavepoint(savepointIds.incrementAndGet(), name == null || name.isBlank() ? null : name);
    ...
    public void close() throws SQLException {
        ...
        for (JavaDbStatement statement : List.copyOf(openStatements)) {
            try {
                statement.close();
    ...
    public java.sql.Clob createClob() throws SQLException {
        ensureOpen();
        return new JavaDbClob();
    }

    @Override
    public java.sql.Blob createBlob() throws SQLException {
        ensureOpen();
        return new JavaDbBlob();
    }

    @Override
    public java.sql.NClob createNClob() throws SQLException {
        ensureOpen();
        return new JavaDbNClob();
    }

    @Override
    public java.sql.SQLXML createSQLXML() throws SQLException {
        ensureOpen();
        return new JavaDbSqlXml();
    }
    ...
    private JavaDbSavepoint requireSavepoint(Savepoint savepoint) throws SQLException {
        if (!(savepoint instanceof JavaDbSavepoint javaDbSavepoint)) {
