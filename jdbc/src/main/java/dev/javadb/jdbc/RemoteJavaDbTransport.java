...
final class RemoteJavaDbTransport implements JavaDbTransport {
    ...
    RemoteJavaDbTransport(JavaDbUrl url) throws SQLException {
        try {
            this.url = url;
